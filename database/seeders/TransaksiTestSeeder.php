...
class TransaksiTestSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        // Pastikan ID ini ada di database 'sarpras_testing' Anda
        $userIdMhs = 2; // User 'mahasiswa'
        $teknisiIdPerabot = 4; // Teknisi 'teknisi4' (Perabot)
        $teknisiIdKomputer = 2; // Teknisi 'teknisi2' (Komputer)
        $teknisiUserPerabot = 8; // User ID untuk Teknisi4
        $teknisiUserKomputer = 6; // User ID untuk Teknisi2
