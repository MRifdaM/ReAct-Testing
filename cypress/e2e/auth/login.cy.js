...
describe('Fitur Login Pengguna', () => {
   ...
   */
  it('TC_LOGIN_001 - Harus berhasil login dengan kredensial yang valid', () => {
   ...
   */
  it('TC_LOGIN_002 - Harus menampilkan popup error jika password salah dan tetap di halaman login', () => {
    cy.get(SELECTOR_USERNAME).should('be.visible').type(USERNAME_VALID);
   ...
   * Pengguna harus tetap berada di halaman login setelah menutup popup.
   */
  it('TC_LOGIN_003 - Harus menampilkan popup error jika username salah', () => {
   ...
   */
  it('TC_LOGIN_004 - Harus menandai field username dan password sebagai tidak valid jika kosong saat submit', () => {
    cy.get(SELECTOR_SUBMIT_BTN).should('be.visible').click();
   ...
   */
  it('TC_LOGIN_005 - Harus bisa mengklik link "Sign up" dan diarahkan ke halaman registrasi', () => {
